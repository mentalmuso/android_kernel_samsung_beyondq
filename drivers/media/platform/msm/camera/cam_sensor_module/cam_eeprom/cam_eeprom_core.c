...
extern int ois_gain_rear2_result;
extern int ois_sr_rear2_result;
#endif
#endif
	...
	else if (e_ctrl->soc_info.index == CAM_EEPROM_IDX_FRONT2)
    {
		...
		if (e_ctrl->cal_data.num_data > 0xAF00) {
			...
			if (ois_tele_cal_mark == 0xBB) {
				ois_gain_rear2_result = 0;
				ois_sr_rear2_result = 0;
			} else {
				ois_gain_rear2_result = 1;
				ois_sr_rear2_result = 1;
			}
