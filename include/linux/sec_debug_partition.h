...
#define SEC_DEBUG_RESET_EXTRC_OFFSET		(SEC_DEBUG_RESET_TZLOG_OFFSET +\
			ALIGN(SEC_DEBUG_RESET_TZLOG_SIZE, SECTOR_UNIT_SIZE)) /* 5*1024*1024 + 12*1024*/
#define SEC_DEBUG_RESET_EXTRC_SIZE		(2*1024)		/* 2KB */

#define SEC_DEBUG_AUTO_COMMENT_OFFSET		(SEC_DEBUG_RESET_EXTRC_OFFSET +\
			ALIGN(SEC_DEBUG_RESET_EXTRC_SIZE, SECTOR_UNIT_SIZE)) /* 5*1024*1024 + 12*1024 + 4KB */
